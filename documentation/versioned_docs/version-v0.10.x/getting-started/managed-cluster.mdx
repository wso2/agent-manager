...
kubectl apply -f https://raw.githubusercontent.com/wso2/agent-manager/amp/v0.10.0/deployments/values/obs-gateway.yaml
...
kubectl apply -f https://raw.githubusercontent.com/wso2/agent-manager/amp/v0.10.0/deployments/values/otel-collector-rest-api.yaml
