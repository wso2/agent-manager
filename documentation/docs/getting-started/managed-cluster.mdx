...
The Platform Resources Extension creates default resources and build workflow templates:

- Default Organization
- Default Project
- Environment
- DeploymentPipeline
- Build workflow templates for container images

**Registry Configuration:**

In Phase 1, Step 4, you installed OpenChoreo Build Plane and configured a registry endpoint. The Platform Resources Extension must use the **same registry endpoint**.
...
# Install Platform Resources Extension with the same registry endpoint
...
**Note:** This extension is non-fatal if installation fails. The platform will function, but default resources and build CI features may not be available.
