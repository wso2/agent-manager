  ...
  "trace": {
    ...
    "nodes": [
      ...
      },
      {
        "name": "get_context()",
        "type": "str",
        "description": "Get combined context from retrievals and tool outputs (for RAG evaluation).",
        "isMethod": true
      },
      {
        "name": "get_llm_calls()",
...
export const COMPLETIONS: Record<EvaluatorLevel, CompletionSuggestion[]> = {
  ...
  {
    "label": "trace.get_context()",
    "kind": "Method",
    "insertText": "trace.get_context()",
    "detail": "str",
    "documentation": "Get combined context from retrievals and tool outputs (for RAG evaluation).",
    "sortText": "3"
  },
  {
