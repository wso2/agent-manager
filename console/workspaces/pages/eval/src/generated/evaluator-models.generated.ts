  ...
  "trace": {
    ...
    "nodes": [
      ...
      },
      {
        "name": "spans",
        "type": "List[Span]",
        "description": "All execution spans ordered by start time, one of the following types:",
        "children": [
          {
            "name": "LLMSpan",
            "type": "",
      ...
      },
      {
        ...
        "type": "str",
        "description": "Format tool results and retrieved documents for LLM-friendly display.",
        "isMethod": true
      },
      {
        "name": "format_spans()",
        "type": "str",
        "description": "Render the full span tree using parent_span_id hierarchy.",
        "isMethod": true
      },
      {
        "name": "get_agents()",
      ...
      },
      {
        "name": "get_llm_calls()",
        "type": "List[LLMSpan]",
        "description": "Get all LLM calls with enhanced filtering and deduplication.",
        "isMethod": true,
        "children": [
          {
            "name": "input",
  ...
  "agent": {
    ...
    "nodes": [
          ...
          },
          {
            ...
            "children": [
              ...
              },
              {
                "name": "is_response",
                "type": "bool",
                "description": "True if this is a final response (no tool calls requested)."
              }
            ]
          },
          {
      ...
      },
      {
        "name": "format_steps()",
        "type": "str",
        "description": "Format execution steps as a numbered list for LLM-friendly display.",
        "isMethod": true
      },
      {
    ...
    "nodes": [
      {
        "name": "input",
        "type": "List[Message]",
        "description": "Conversation messages sent to the LLM, one of the following types:",
        "children": [
          {
            "name": "SystemMessage",
            "type": "",
  ...
  "eval_result": {
    ...
    "nodes": [
      ...
      },
      {
        "name": "skip(reason)",
        "type": "EvalResult",
        "description": "Create a skipped result when evaluation cannot be performed.",
        "isMethod": true
      }
    ]
  }
...
export const COMPLETIONS: Record<EvaluatorLevel, CompletionSuggestion[]> = {
  ...
  },
  {
    ...
    "detail": "str",
    "documentation": "Format tool results and retrieved documents for LLM-friendly display.",
    "sortText": "3"
  },
  {
    ...
    "detail": "str",
    "documentation": "Render the full span tree using parent_span_id hierarchy.",
    "sortText": "3"
  },
  {
  ...
  },
  {
    ...
    "detail": "List[LLMSpan]",
    "documentation": "Get all LLM calls with enhanced filtering and deduplication.",
    "sortText": "3"
  },
  {
  ...
  },
  {
    ...
    "detail": "List[SystemMessage | UserMessage | AssistantMessage | ToolMessage]",
  ...
  },
  {
    ...
    "detail": "str",
    "documentation": "Format execution steps as a numbered list for LLM-friendly display.",
    "sortText": "3"
  },
  {
  ...
  },
  {
    ...
    "detail": "bool",
    "documentation": "True if this is a final response (no tool calls requested).",
    "sortText": "4"
  },
  {
  ...
  },
  {
    ...
    "kind": "Snippet",
    "insertText": "isinstance(${1:input}, ${2|SystemMessage,UserMessage,AssistantMessage,ToolMessage|})",
    "snippet": true,
    "detail": "Type check",
