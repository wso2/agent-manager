...
import { Box, Card, CardContent, Chip, Typography, Stack } from "@wso2/oxygen-ui";
            ...
            <Card variant="outlined">
                <CardContent>
                    ...
                    {radarChartData.length === 0 ? (
                        ...
                        >
                            <ChartTooltip
                                content={({ active, payload }: { active?: boolean; payload?: Array<{ value?: number; payload?: RadarDataPoint }> }) => {
                                        ...
                                        <Card variant="outlined">
                                            <CardContent sx={{ py: 1, px: 1.5, "&:last-child": { pb: 1 } }}>
                                                ...
                                                {dataPoint._isNoData ? (
                                                    ...
                                                    <Typography variant="caption" color="text.secondary">
                                                        ({dataPoint._scoredCount}/{dataPoint._totalCount} {cfg.unit})
                                                    </Typography>
                                                )}
                                            </CardContent>
                                        </Card>
