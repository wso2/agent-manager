...
import { Timeline, Speed } from '@mui/icons-material';
...
function TopCardsSkeleton() {
    ...
    return (
        <Box sx={{
            ...
            <Skeleton variant="rectangular" height={theme.spacing(15)} />
            <Skeleton variant="rectangular" height={theme.spacing(15)} />
            <Skeleton variant="rectangular" height={theme.spacing(15)} />
        </Box>
    );
...
export const TopCards: React.FC<TopCardsProps> = ({ timeRange }) => {
    const theme = useTheme();
    ...
    return (
        <Box sx={{
            ...
            <StatusCard
                ...
                icon={<Timeline />}
                iconVariant="info"
                tag={`in last ${timeRangeLabel.toLowerCase()}`}
                tagVariant="info"
                minWidth="100%"
            />
            <StatusCard
                ...
                tag={`${averageDurationSeconds}s avg`}
