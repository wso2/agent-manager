...
export const CreateGitSecretModal = ({
  ...
  const handleFieldChange = useCallback(
    (field: keyof FormState, value: string) => {
      ...
      if (errors[field]) {
        setErrors((prev: Partial<Record<keyof FormState, string>>) => ({ ...prev, [field]: undefined }));
      }
    },
    [errors]
  );
        ...
        <Form.Stack spacing={3} sx={{ mt: 1 }}>
          ...
          <Form.ElementWrapper label="Username" name="username">
            <TextField
              ...
              onChange={(e: ChangeEvent<HTMLInputElement>) => handleFieldChange('username', e.target.value)}
          ...
          <Form.ElementWrapper label="Personal Access Token" name="password">
            <TextField
              ...
              onChange={(e: ChangeEvent<HTMLInputElement>) => handleFieldChange('password', e.target.value)}
