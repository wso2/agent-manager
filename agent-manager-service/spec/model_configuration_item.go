...
func NewConfigurationItem(key string, value string) *ConfigurationItem {
...
func (o *ConfigurationItem) GetValue() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ConfigurationItem) GetValueOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Value, true
...
func (o *ConfigurationItem) SetValue(v string) {
	o.Value = v
}
