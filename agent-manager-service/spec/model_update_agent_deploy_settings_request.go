...
func (o *UpdateAgentDeploySettingsRequest) GetAgentCardCorsConfig() AgentCardCORSConfig {
...
// and a boolean to check if the value has been set.
func (o *UpdateAgentDeploySettingsRequest) GetAgentCardCorsConfigOk() (*AgentCardCORSConfig, bool) {
	if o == nil || IsNil(o.AgentCardCorsConfig) {
		return nil, false
	}
...
func (o *UpdateAgentDeploySettingsRequest) HasAgentCardCorsConfig() bool {
	if o != nil && !IsNil(o.AgentCardCorsConfig) {
		return true
	}
...
func (o *UpdateAgentDeploySettingsRequest) SetAgentCardCorsConfig(v AgentCardCORSConfig) {
