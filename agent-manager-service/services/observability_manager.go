...
// NewObservabilityManager creates an ObservabilityManagerService backed by the provided
// TraceObserverClient and logger.
// 
// The returned service uses the client to perform trace observer calls and the logger
// for structured logging of operations and errors.
