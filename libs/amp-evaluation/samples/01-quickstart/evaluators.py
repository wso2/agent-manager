...
"""
Quickstart evaluator: a simple response check using the @evaluator decorator.
"""
...
@evaluator("response-check", description="Checks that the agent produced a response")
def response_check(trace: Trace) -> EvalResult:
