...
- [Installation on self hosted kubernetes cluster](./self-hosted-cluster.mdx)
- [Installation on managed kubernetes cluster](./managed-cluster.mdx)
- [What is AMP?](../overview/what-is-amp.mdx) - Project overview and architecture
