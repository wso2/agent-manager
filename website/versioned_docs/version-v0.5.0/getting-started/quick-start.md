...
- [Installation on self hosted kubernetes cluster](./self-hosted-cluster.md)
- [Installation on managed kubernetes cluster](./managed-cluster.md)
- [What is AMP?](../overview/what-is-amp.md) - Project overview and architecture
